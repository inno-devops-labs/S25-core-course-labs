...
2. Build the Docker image:
   ...
   ```bash
   docker build -t ali12hamdan/app_python:app_python-prod-1.0.0 --no-cache=True .
   ```
...
1. Run the Docker container:
   ...
   ```bash
   docker run -d -p 5000:5000 --name app_python ali12hamdan/app_python:app_python-prod-1.0.0
   ```
...
2. Push the Docker image:
   ...
   ```bash
   docker push ali12hamdan/app_python:app_python-prod-1.0.0
   ```
...
1. Pull the Docker image:
   ...
   ```bash
   docker pull ali12hamdan/app_python:app_python-prod-1.0.0
   ```
...
2. Build the Distroless Docker image:
   ...
   ```bash
   docker build -t ali12hamdan/app_python:app_python-distroless-prod-1.0.0 --file distroless.Dockerfile --no-cache=True .
   ```
...
1. Run the Distroless Docker container:
   ...
   ```bash
   docker run -d -p 5000:5000 --name app_python_distroless ali12hamdan/app_python:app_python-distroless-prod-1.0.0
   ```
...
2. Push the Distroless Docker image:
   ...
   ```bash
   docker push ali12hamdan/app_python:app_python-distroless-prod-1.0.0
   ```
...
1. Pull the Distroless Docker image:
   ...
   ```bash
   docker pull ali12hamdan/app_python:app_python-distroless-prod-1.0.0
   ```
