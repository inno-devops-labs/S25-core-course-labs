...
## Task 1
Все изменения для выполнения этого задания я внес и указал в README.md файле веб приложения. 

## Task 2

Я создал все необходимые файлы для ConfigMaps. Теперь проверим, что они сработали. 
...
```
lekski@LAPTOP-EA8M0FT5:/mnt/c/Users/Honor/Desktop/S25-core-course-labs/k8s$ kubectl exec web-apps-5d797b94f9-hb2kz -- printenv config.json
Defaulted container "web-apps" out of: web-apps, vault-agent, vault-agent-init (init)
E0306 17:17:32.715320  113754 websocket.go:296] Unknown stream id 1, discarding message
