...
```
emildavlityarov@emapfff S25-core-course-labs % kubectl create secret generic real-secret --from-literal=token=SECRET_VALUE
secret/real-secret created

emildavlityarov@emapfff S25-core-course-labs % kubectl describe secret real-secret
Name:         real-secret
Namespace:    default
Labels:       <none>
Annotations:  <none>
...
emildavlityarov@emapfff S25-core-course-labs % Write-Output ([System.Text.Encoding]::Utf8.GetString([System.Convert]::FromBase64String((kubectl get secret real-secret -o jsonpath='{.data.token}'))))
SECRET_VALUE

emildavlityarov@emapfff S25-core-course-labs k8s/helm/app-python % kubectl get po
NAME                          READY   STATUS    RESTARTS   AGE
app-python-74496b96dc-z472j   1/1     Running   0          99s

emildavlityarov@emapfff S25-core-course-labs k8s/helm/app-python % kubectl exec app-python-74496b96dc-z472j -- printenv | grep "SECRET"
SECRET=SECRET_VALUE
```
...
```
emildavlityarov@emapfff S25-core-course-labs k8s/helm/app-python % kubectl describe po app-python-844bdfdf5d-zjm6l
...
Events:
  ...
  Normal   Pulled     49s                kubelet            Container image "emapfff/app_python:latest" already present on machine
  Normal   Created    49s                kubelet            Created container app-python
  Normal   Started    49s                kubelet            Started container app-python
```

```
emildavlityarov@emapfff S25-core-course-labs k8s/helm/app-python % kubectl describe po app-kotlin-67bc4f7655-dbvlt
...
Events:
  ...
  Normal   Pulled     15s               kubelet            Container image "emapfff/app_kotlin:latest" already present on machine
