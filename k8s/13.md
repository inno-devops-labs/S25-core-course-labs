...
SyncWindow:         Sync Allowed
Sync Policy:        Automated
Sync Status:        Synced to lab13 (95e9550)
Health Status:      Healthy
...
└─ReplicaSet/python-app-prod-app-python-helm-68d478b4c4           Healthy  
  ├─Pod/python-app-prod-app-python-helm-68d478b4c4-p6f62          Healthy  
...
SyncWindow:         Sync Allowed
Sync Policy:        Automated
Sync Status:        OutOfSync from lab13 (95e9550)
Health Status:      Progressing

KIND/NAME                                                 STATUS     HEALTH       MESSAGE
Deployment/python-app-prod-app-python-helm                OutOfSync  Progressing  
├─ReplicaSet/python-app-prod-app-python-helm-58645759db              Healthy      
└─ReplicaSet/python-app-prod-app-python-helm-68d478b4c4              Progressing  
  ├─Pod/python-app-prod-app-python-helm-68d478b4c4-4pzrb             Progressing  
  ├─Pod/python-app-prod-app-python-helm-68d478b4c4-5xvt6             Progressing  
  ├─Pod/python-app-prod-app-python-helm-68d478b4c4-6t9d4             Progressing  
  ├─Pod/python-app-prod-app-python-helm-68d478b4c4-7t467             Progressing  
  ├─Pod/python-app-prod-app-python-helm-68d478b4c4-9wflx             Progressing  
  ├─Pod/python-app-prod-app-python-helm-68d478b4c4-p6f62             Healthy      
  ├─Pod/python-app-prod-app-python-helm-68d478b4c4-t9dbl             Progressing  
  ├─Pod/python-app-prod-app-python-helm-68d478b4c4-wk9qx             Healthy      
  ├─Pod/python-app-prod-app-python-helm-68d478b4c4-zdj7w             Progressing  
  └─Pod/python-app-prod-app-python-helm-68d478b4c4-zjtqm             Healthy      
ConfigMap/app-python-helm-config                          Synced                  
Pod/python-app-prod-pre-install-hook                      Running                 pod/python-app-prod-pre-install-hook created
Service/python-app-prod-app-python-helm                   Synced     Healthy      
├─Endpoints/python-app-prod-app-python-helm                                       
└─EndpointSlice/python-app-prod-app-python-helm-f8f6p                             
ServiceAccount/app-python                                 Synced
```

Check the status of the application again after some time
...
Screenshot of UI after test:

![ArgoCD Dashboard](img/f3.png)
...
NAME                                               READY   STATUS    RESTARTS   AGE
python-app-prod-app-python-helm-68d478b4c4-p6f62   1/1     Running   0          63m
python-app-prod-app-python-helm-68d478b4c4-wk9qx   1/1     Running   0          112m
python-app-prod-app-python-helm-68d478b4c4-zjtqm   1/1     Running   0          112m
```

Delete a pod

```bash
kubectl delete pod -n prod python-app-prod-app-python-helm-68d478b4c4-p6f62

pod "python-app-prod-app-python-helm-68d478b4c4-p6f62" deleted
```
...
python-app-prod-app-python-helm-68d478b4c4-wk9qx   1/1     Running   0          112m
python-app-prod-app-python-helm-68d478b4c4-zjtqm   1/1     Running   0          112m
python-app-prod-app-python-helm-68d478b4c4-p6f62   1/1     Terminating   0          63m
python-app-prod-app-python-helm-68d478b4c4-c4ljr   0/1     Pending       0          0s
python-app-prod-app-python-helm-68d478b4c4-c4ljr   0/1     Pending       0          0s
python-app-prod-app-python-helm-68d478b4c4-c4ljr   0/1     ContainerCreating   0          0s
python-app-prod-app-python-helm-68d478b4c4-p6f62   0/1     Completed           0          63m
python-app-prod-app-python-helm-68d478b4c4-p6f62   0/1     Completed           0          63m
python-app-prod-app-python-helm-68d478b4c4-p6f62   0/1     Completed           0          63m
python-app-prod-app-python-helm-68d478b4c4-c4ljr   0/1     Running             0          2s
python-app-prod-app-python-helm-68d478b4c4-c4ljr   1/1     Running             0          13s
```
...
NAME                                               READY   STATUS    RESTARTS   AGE
python-app-prod-app-python-helm-68d478b4c4-c4ljr   1/1     Running   0          44s
python-app-prod-app-python-helm-68d478b4c4-wk9qx   1/1     Running   0          113m
python-app-prod-app-python-helm-68d478b4c4-zjtqm   1/1     Running   0          113m
```
