...
2. Verify CLI installation:
   ...
   **Output:**
   ...
   argocd: v2.14.4+3d901f2
     ...
     GitCommit: 4f901f2037888af302a85f422bea70b33ee8e1c7
     GitTreeState: clean
     GoVersion: go1.23.3
     Compiler: gc
...
3. Open the ArgoCD dashboard:
   ...
   ![ArgoCD Dashboard](screen-sh/da-1.png)
...
3. Observe ArgoCD auto-sync the update.
   ...
   ![Sync Workflow](screen-sh/da-3.png)
...
1. Test auto-sync by updating `values-prod.yaml` and pushing to Git.
   ...
   ![Auto-Sync Test](screen-sh/da-4.png)
...
1. Modify the deployment’s replica count manually:
   ...
   **Output:**
   ...
   ![alt text](screen-sh/da-5.png)

2. Observe ArgoCD auto-revert the change:

   ![Auto-Revert](screen-sh/da-6.png)
...
python-app-prod-app-python-7496cff74-b8qkq   1/1     Running             0          21m
python-app-prod-app-python-7496cff74-nwb9b   1/1     Terminating         0          3m38s
python-app-prod-app-python-7496cff74-tgmbj   1/1     Terminating         0          3m38s
```
...
- Show the pods before:
  ...
  ```log
  NAME                                         READY   STATUS    RESTARTS   AGE
  python-app-prod-app-python-7496cff74-b8qkq   1/1     Running   0          22m
  ```
...
```log
pod "python-app-prod-app-python-7496cff74-b8qkq" deleted
```
...
- Verify Kubernetes recreates the pod:
   ...
   **Output:**
   ...
   ```log
   NAME                                         READY   STATUS    RESTARTS   AGE
   python-app-prod-app-python-7496cff74-qnx64   1/1     Running   0          67s
   ```

- Confirm ArgoCD shows no drift:

   ![No Drift](screen-sh/drift.png)

- Show the Dashboard:

   ![dashboard-test2](screen-sh/da-t-2.png)
...
1. Configure ArgoCD for Bonus App:
   ...
   **Output:**
   ...
   ```log
   NAME                                     READY   STATUS    RESTARTS        AGE
   app-go-55669c4956-sssql                  1/1     Running   1 (8h ago)     15h
   app-python-8d8c5f6fd-jtb88               1/1     Running   1 (6h44m ago)   15h
   go-app-app-go-66766bd684-6k6lf           1/1     Running   0               66s
   python-app-app-python-644f95d77d-49hkg   1/1     Running   0               4h4m
   python-app-app-python-644f95d77d-fqtsr   1/1     Running   0               4h4m
   python-app-app-python-644f95d77d-ssfvz   1/1     Running   1 (6h44m ago)   12h
   ```

2. Show the app from dashboard:
   ![dashboard-app-go](screen-sh/da-go.png)
