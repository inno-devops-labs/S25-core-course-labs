...
batch  Job                    default    python-app-post-install-hook  Succeeded               PostSync  Reached expecte
```
![image](https://github.com/user-attachments/assets/572f0d1e-fe22-4cba-9ef5-8ae5c9996767)
...
```
## Test 1 
If I have a lot of deployments, I use bakcend deployment modification:
``` bash
...
```
Gives nothing and it is correct
![image](https://github.com/user-attachments/assets/e5ca47e8-2d9c-46b3-9e62-5a03d740a3f1)
