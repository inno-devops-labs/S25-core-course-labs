...
2.Install Kubernetes tools on my machine
...
after creating `dpeloyment.yml` and apply :
...
bouns:
after creating go-deployment.yml and apply and go-service.yml and apply it:
...
HTTP/1.1 200 OK
Date: Mon, 24 Feb 2025 16:27:37 GMT
...
HTTP/1.1 200 OK
Date: Mon, 24 Feb 2025 17:27:10 GMT
Content-Type: text/html; charset=utf-8
Content-Length: 262
Connection: keep-alive
