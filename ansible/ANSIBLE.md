...
Running again with edited roles:

```bash
[nvy@nvy ansible]$ ansible-playbook -i inventory/default_yandex.yml playbooks/dev/main.yaml --skip-tags docker
...
ok: [yandex_vm]
...
TASK [web_app : Check if compose file exists] **********************************************************************************************************************************************************************
ok: [yandex_vm]

TASK [web_app : Shut down any running containers and remove images] ************************************************************************************************************************************************
skipping: [yandex_vm]

TASK [web_app : Delete the application directory if it exists] *****************************************************************************************************************************************************
skipping: [yandex_vm]

TASK [web_app : Create application directory] **********************************************************************************************************************************************************************
changed: [yandex_vm]

TASK [web_app : Render docker-compose configuration] ***************************************************************************************************************************************************************
changed: [yandex_vm]
...
PLAY RECAP *********************************************************************************************************************************************************************************************************
yandex_vm                  : ok=26   changed=3    unreachable=0    failed=0    skipped=2    rescued=0    ignored=0
```

Here is the result of the output from yandex cloud vm:
```bash
[hacker@nvy nvy]$ ssh admin@158.160.144.225
admin@compute-vm-2-2-20-ssd-1739717002688:~$ docker ps
CONTAINER ID   IMAGE                    COMMAND                  CREATED              STATUS              PORTS                                       NAMES
f77c74f19a25   jlfkajlkifj/app_python   "uvicorn app:app --h…"   About a minute ago   Up About a minute   0.0.0.0:8000->8000/tcp, :::8000->8000/tcp   py-webapp
```

The running app on host:
![](./ansible_web.png)
