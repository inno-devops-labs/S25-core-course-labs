...
### Deployment Output:
The **last 50 lines** of the output from deployment command:
...
PLAY RECAP *********************************************************************
vm                         : ok=25   changed=2    unreachable=0    failed=0    skipped=0    rescued=0    ignored=0
```
...
PLAY RECAP *********************************************************************
vm                         : ok=2    changed=0    unreachable=0    failed=0    skipped=0    rescued=0    ignored=0  
```
