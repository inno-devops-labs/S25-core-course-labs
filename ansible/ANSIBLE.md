...
# Bonus task (deploying app_js)

#### ```ansible-playbook -i inventory/default_yandex.yml playbooks/dev/app_js/main.yaml```

```
PLAY [Deploy Node.js app] ********************************************************************************************************************************************
...
![js app image](./readme_images/app_js.png)