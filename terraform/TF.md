...
4. **Importing an Existing Repository**:
   ...
   - State of the imported repository:
     ...
     resource "github_repository" "S25-core-course-labs" {
         ...
         full_name                   = "Mohammed-Nour/S25-core-course-labs"
         git_clone_url               = "git://github.com/Mohammed-Nour/S25-core-course-labs.git"
         ...
         has_wiki                    = true
         homepage_url                = null
         html_url                    = "https://github.com/Mohammed-Nour/S25-core-course-labs"
         http_clone_url              = "https://github.com/Mohammed-Nour/S25-core-course-labs.git"
         ...
         ssh_clone_url               = "git@github.com:Mohammed-Nour/S25-core-course-labs.git"
         svn_url                     = "https://github.com/Mohammed-Nour/S25-core-course-labs"
         topics                      = []
         visibility                  = "public"
