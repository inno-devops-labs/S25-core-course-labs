...
```sh
  ...
  -/+ resource "docker_container" "app_python" {
        ...
        ~ image                                       = "sha256:de4f047721fee1e47ab5a3be2dc3236d4e5104060db786b2b6a5c16ad7620840" -> "kartofanych/app_python" # forces replacement
...
```sh
  ...
  image_id = "kartofanych/app_python"
```

## Yandex Cloud

```sh
  > yc iam service-account create --name kartofanych
  id: ajee9o77dum38ubcgloh
  folder_id: b1gm8det1qvec4u1gk4o
  created_at: "2025-04-26T06:54:35.561039119Z"
  name: kartofanych
```
...
```sh
  ...
  +----------------------+------------+--------+---------------------+-----------------------+
  | ajee9o77dum38ubcgloh | kartofanych |        | 2025-02-06 06:54:35 | 2025-04-28 18:40:00   |
  +----------------------+------------+--------+---------------------+-----------------------+
```
...
```sh
  ...
  created_at: "2025-04-29T22:21:58.561039119Z"
...
#### Update `main.tf` and Create `variables.tf`
...
```sh
  ...
  -/+ resource "yandex_vpc_subnet" "default" {
        ~ created_at     = "2025-04-29T22:46:22Z" -> (known after apply)
...
```sh
  ...
  Terraform will perform the following actions:
    ...
    - resource "yandex_compute_instance" "default" {
        - created_at                = "2025-04-29T22:47:31Z" -> null
    ...
    - resource "yandex_vpc_network" "default" {
        - created_at                = "2025-04-29T22:36:44Z" -> null
    ...
    - resource "yandex_vpc_subnet" "default" {
        - created_at     = "2025-04-29T22:47:30Z" -> null
        - folder_id      = "b1gm8det1qvec4u1gk4o" -> null
